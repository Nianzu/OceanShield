...
marker_1 = map_widget.set_address("Brandenburger Tor", marker=True, image_zoom_visibility=(14, float("inf")))
...
marker_2 = map_widget.set_marker(52.47314336937092, 13.40380288606593, text="Old airport",
